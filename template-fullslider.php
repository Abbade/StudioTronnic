								...
								<div class="images">
									<?php if (!empty ($slide['link'])) { ?>
										...
										<a href="<?php echo $slide['link']; ?>" title="">
											...
											<img width="" height="500px" class="check"  src="<?php echo $slide['url']; ?>"  alt="<?php echo htmlspecialchars(stripslashes($slide['title'])); ?> "/>
										</a>
						...
						<?php } else {?>
							<div id="slider-wrapper-iframe">
								<?php if(strpos($slide['video'], 'vimeo')){	?>
									<div class="iframes">
										<iframe src="<?php echo $slide['video'] ?>" width="550" height="320" ></iframe>
								...
								<?php } else { ?>
									<div class="iframes">
										<iframe src="<?php echo $slide['video'] ?>" width="550" height="320" rel="youtube" ></iframe>
...
<div id="mainwrap" style="margin-top:-80px;">
