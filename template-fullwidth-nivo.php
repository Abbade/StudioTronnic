		...
		if(isset($data['nivo_slider'])){
			...
			foreach ($slides as $slide) { 
			  ...
			  if($slide['url'] != '') :
				 ...
				 if($slide['link'] != '') : ?>
				   <a href="<?php echo $slide['link']; ?>"><img height="380px" width="940px" src="<?php echo $slide['url']; ?>" title="<?php echo stripText($slide['description']); ?>" alt="<?php echo stripText($slide['title']); ?>" /></a>
				<?php else: ?>
					<img height="380px" width="940px" src="<?php echo $slide['url']; ?>" title="<?php echo stripText($slide['description']); ?>" alt="<?php echo stripText($slide['title']); ?>" />
				<?php endif; ?>
