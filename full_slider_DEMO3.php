								...
								<div class="images">
									<?php if (!empty ($slide['link'])) { ?>
										...
										<a href="<?php echo $slide['link']; ?>" title="">
											...
											<img width="" class="check"  src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php echo $slide['url']; ?>&amp;h=500&amp;w="  alt="<?php echo htmlspecialchars(stripslashes($slide['title'])); ?> "/>
										</a>
