...
.widget_tag_cloud a:hover, .widget_product_tag_cloud a:hover, #respond #commentform input#submit:hover, .woocommerce .cart .button:hover, .woocommerce .cart input.button:hover, table.cart td.actions .button:hover{background:<?php echo $data['mainColor']; ?> !important;}
