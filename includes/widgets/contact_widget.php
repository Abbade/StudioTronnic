...
class contact extends WP_Widget {
	...
	function contact() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'contact-widget', __('musica Contact Widget', 'wp-musica'), $widget_ops, '' );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'mail' ); ?>"><?php _e('Your email:', 'wp-musica') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tel_mob' ); ?>"><?php _e('Your mobile telephone number:', 'wp-musica') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tel_local' ); ?>"><?php _e('Your local telephone number:', 'wp-musica') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vcard' ); ?>"><?php _e('Your VCARD contact:', 'wp-musica') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vcardlink' ); ?>"><?php _e('Your VCARD link:', 'wp-musica') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'msn' ); ?>"><?php _e('Your MSN contact:', 'wp-musica') ?></label>
