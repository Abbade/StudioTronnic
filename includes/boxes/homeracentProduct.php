...
<div class="homeRacent">
	...
	<h2><?php if (!function_exists('icl_object_id') or (ICL_LANGUAGE_CODE == $sitepress->get_default_language()) ) { echo stripText($data['translation_recent_pruduct_title']); } else {  _e('Recent Products','wp-musica'); } ?></h2>
