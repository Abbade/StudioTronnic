...
$content .= '<a href="'.$tab['link'] .'"><img class="hideimage" alt="'. stripText($tab['title']) .'" style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. $tab['imageurl'] .'" title="'. stripText($tab['title']) .'" rel="'. $tab['imageurl'] .'"></a>';

else

$content .= '<img alt="'. stripText($tab['title']) .'" class="hideimage" style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. $tab['imageurl'] .'" title="'. stripText($tab['title']) .'" rel="'. $tab['imageurl'] .'">';
...
$content .= '<a href="'.$tab['link'] .'"><img alt="'. stripText($tab['title']) .'" style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. $tab['imageurl'] .'&amp;h='.$tab['height'].'"></a>';

else

$content .= '<img alt="'. stripText($tab['title']) .'" style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. $tab['imageurl'] .'" title="'. stripText($tab['title']) .'">';
...
$return = "<script>jQuery(document).ready(function () {jQuery('.nivoSlider').nivoSlider({effect:'".$data['effect'] ."', // Specify sets like: 'fold,fade,sliceDown'
slices:". $data['slices'] .", // For slice animations
        boxCols: ". $data['boxcols'] .", // For box animations
        boxRows: ". $data['boxrows'] .", // For box animations
        animSpeed:". $data['anispeed'] .", // Slide transition speed
...
$panes[] = '<div class="pane" id="fragment-'.$i.'"><h3>'.$tab['title'].'</h3>'.$tab['content'].'</div>';
