...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-musica'),
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('&laquo; First','wp-musica'),
		'last_text' => __('Last &raquo;','wp-musica'),
		'next_text' => __('&raquo;','wp-musica'),
		'prev_text' => __('&laquo;','wp-musica'),
		'dotright_text' => __('...','wp-musica'),
		'dotleft_text' => __('...','wp-musica'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
