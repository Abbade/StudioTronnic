		...
		<div class="homeBox ">
			<div class="one_third first">
				<a href="<?php if(isset($data['box1_link'])) echo $data['box1_link']?>">
					<div class="image">
						...
						<img src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php if (isset($data['box1_image'])) echo $data['box1_image']; else echo get_template_directory_uri().'/images/placeholder-580-small.png';?>&amp;h=25&amp;w=25" alt="<?php echo stripText($data['box1_title']) ?>">
					</div>
			...
			<div class="one_third second">
				<a href="<?php if(isset($data['box2_link'])) echo $data['box2_link']?>">
					<div class="image">
						<div class="loading"></div>
						<img src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php if (isset($data['box2_image'])) echo $data['box2_image']; else echo get_template_directory_uri().'/images/placeholder-580-small.png';?>&amp;h=25&amp;w=25" alt="<?php echo stripText($data['box2_title']) ?>">
					</div>
			...
			<div class="one_third last third">	
				<a href="<?php if(isset($data['box3_link'])) echo $data['box31_link']?>">
					<div class="image">
						<div class="loading"></div>
						<img src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php if (isset($data['box3_image'])) echo $data['box3_image']; else echo get_template_directory_uri().'/images/placeholder-580-small.png';?>&amp;h=25&amp;w=25" alt="<?php echo stripText($data['box3_title']) ?>">
					</div>
