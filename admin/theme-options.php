...
add_action('init','of_options_musica_pmc');

if (!function_exists('of_options_musica_pmc')) {
function of_options_musica_pmc(){
...
//Testing 
$of_options_musica_pmc_select = array("one","two","three","four","five"); 
$of_options_musica_pmc_radio = array("one" => "One","two" => "Two","three" => "Three","four" => "Four","five" => "Five");
$of_options_musica_pmc_homepage_blocks = array( 
	"disabled" => array (
...
$of_options_musica_pmc_thumb_align = array("alignleft" => "Left","alignright" => "Right","aligncenter" => "Center"); 

// Image Links to Options
$of_options_musica_pmc_image_link_to = array("image" => "The Image","post" => "The Post"); 

// Set the Options Array
global $of_options_musica_pmc;
$of_options_musica_pmc = array();



$of_options_musica_pmc[] = array( "name" => "Home Settings",
					"type" => "heading");
				
$of_options_musica_pmc[] = array( "name" => "General settings",
                    "type" => "innerheading");	

$of_options_musica_pmc[] = array( "name" => "Allow responsive mode?",
					"desc" => "Check this if you wish to allow responsive mode.",
					"id" => "showresponsive",
					"std" => 1,
					"type" => "checkbox");						
					
$of_options_musica_pmc[] = array( "name" => "Display Our major brands box on home page?",
					"desc" => "Check this if you wish to display Our major brands on home page.",
					"id" => "showadvertise",
					"std" => 1,
					"type" => "checkbox");						
					
$of_options_musica_pmc[] = array( "name" => "Display info text on Home page?",
					"desc" => "Check this if you wish to display info text below the slideshow.",
					"id" => "infotext_status",
					"std" => 1,
					"type" => "checkbox");						
					
$of_options_musica_pmc[] = array( "name" => "Display featured items on Home page?",
...
$of_options_musica_pmc[] = array( "name" => "Portfolio and post setting for home page",
                    "type" => "innerheading");								
				
$of_options_musica_pmc[] = array( "name" => "Display recent Portfolio items on the Home page?",
					"desc" => "Check this if you wish to display recent Posts on Home page (under the 3 featured items).",
					"id" => "racent_status_port",
					"std" => 1,
					"type" => "checkbox");					

$of_options_musica_pmc[] = array( "name" => "Number of recent portfolio  on home page",
...
$of_options_musica_pmc[] = array( "name" => "Number of recent portfolio items display per slide",
...
$of_options_musica_pmc[] = array( "name" => "Display recent Posts on the Home page?",
					"desc" => "Check this if you wish to display recent Posts on Home page (under the 3 featured items).",
					"id" => "racent_status",
					"std" => 1,
					"type" => "checkbox");	

$of_options_musica_pmc[] = array( "name" => "Number of recent post items display per slide",
...
$of_options_musica_pmc[] = array( "name" => "Number of recent posts on home page",
...
$of_options_musica_pmc[] = array( "name" =>  "Home recent post design",
...
$of_options_musica_pmc[] = array( "name" => "Woocommerce Settings",
					"type" => "heading");
											

$of_options_musica_pmc[] = array( "name" => "Woocomerce setting for home page",
                    "type" => "innerheading");		

$of_options_musica_pmc[] = array( "name" =>  "Category type for Woocommerce",
...
$of_options_musica_pmc[] = array( "name" => "Display add to cart animation",
					"desc" => "Check if you wish animation when add to cart is clicked",
					"id" => "add_to_cart",
					"std" => 1,
					"type" => "checkbox");						

$of_options_musica_pmc[] = array( "name" => "Display recent Products?",
					"desc" => "Check this if you wish to display recent Products (under the 3 featured items).",
					"id" => "racent_status_product",
					"std" => 1,
					"type" => "checkbox");		
					
$of_options_musica_pmc[] = array( "name" => "Number of recent Products on home page",
...
$of_options_musica_pmc[] = array( "name" => "Number of Products items display per slide",
...
$of_options_musica_pmc[] = array( "name" => "Display Feautured Products?",
...
$of_options_musica_pmc[] = array( "name" => "Number of feautured Products on home page",
...
$of_options_musica_pmc[] = array( "name" => "Number of feautured Products items display per slide",
...
$of_options_musica_pmc[] = array( "name" => "WooCommerce Text",
                    "type" => "innerheading");		

$of_options_musica_pmc[] = array( "name" => "Cart",
                    "desc" => "Translation for cart text.",
                    "id" => "translation_cart",
                    "std" => __('Cart','wp-musica'),
                    "type" => "text");	
	

$of_options_musica_pmc[] = array( "name" => "Share this product title",
                    "desc" => "Translation for Share this product title.",
                    "id" => "translation_share_product",
                    "std" =>  __('<span>Share</span> this product','wp-musica'),
                    "type" => "text");	
					
$of_options_musica_pmc[] = array( "name" => "Live Sample",
                    "desc" => "Translation for live sample audio title in single product view.",
                    "id" => "translation_sample",
                    "std" => __('Live Sample','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Also like product",
                    "desc" => "Translation for Also like product title.",
                    "id" => "translation_also_like",
                    "std" => __('<span>Also</span> like','wp-musica'),
                    "type" => "text");			

$of_options_musica_pmc[] = array( "name" => "Login / Register",
                    "desc" => "Translation for Login / Register.",
                    "id" => "translation_login_register",
                    "std" => __('Login / Register','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Our Futured Products",
                    "desc" => "Translation for Our futured products text.",
                    "id" => "translation_featured",
                    "std" => __('Our Futured Products','wp-musica'),
                    "type" => "text");	
					
$of_options_musica_pmc[] = array( "name" => "Recent Products",
                    "desc" => "Translation for Home page Recebt product title.",
                    "id" => "translation_recent_pruduct_title",
                    "std" => __('Recent Products','wp-musica'),
                    "type" => "text");						

$of_options_musica_pmc[] = array( "name" => "Other WooCommerce settings",
                    "type" => "innerheading");

$of_options_musica_pmc[] = array( "name" => "Use WooCommerce ZOOM function",
					"desc" => "Check if you to use ZOOM function",
					"id" => "woo_zoom",
					"std" => 1,
					"type" => "checkbox");						

$of_options_musica_pmc[] = array( "name" => "Number of Products per page in Shop",
...
$of_options_musica_pmc[] = array( "name" => "Catalog image height",
...
$of_options_musica_pmc[] = array( "name" => "Home content Setting",
                    "type" => "heading");

					
					
$of_options_musica_pmc[] = array( "name" => "Quote text",
					...
					"id" => "infotext",
					"std" => __('Welcome to <span>musica</span> - A Minimal Business Theme','wp-musica'),
					"type" => "textarea"); 

$of_options_musica_pmc[] = array( "name" => "Display bottom border under Quote text",
...
$of_options_musica_pmc[] = array( "name" => "Featured Box 1",
                    "type" => "innerheading");						
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 1 Title",
					"desc" => "Title for the first featured box.",
					"id" => "box1_title",
					"std" => __('Featured Box 1 Title','wp-musica'),
					"type" => "text"); 						
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 1 Image (leave empty if you don't need image.)",
					"desc" => "Upload an image for your featured box.",
					"id" => "box1_image",
					"std" =>  "/wp-content/uploads/2012/11/photodune-2461685-mask-xs.jpg",
					"type" => "upload");	

$of_options_musica_pmc[] = array( "name" => "Featured Box 1 Image link",
					"desc" => "Set the link to which the image points on click.",
					"id" => "box1_link",
					"std" => "http://premiumcoding.com",
					"type" => "text"); 							

$of_options_musica_pmc[] = array( "name" => "Featured Box 1 description",
					"desc" => "Set the description text for you featured box.",
					"id" => "box1_description",
					"std" => __('Featured Box 1 Description','wp-musica'),
					"type" => "textarea");
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 1 Background color",
					"desc" => "Set Background color.",
					"id" => "box1_color",
					"std" => "#ffffff",
					"type" => "color");						

$of_options_musica_pmc[] = array( "name" => "Featured Box 2",
                    "type" => "innerheading");	
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 2 Title",
					"desc" => "Title for the second featured box..",
					"id" => "box2_title",
					"std" => __('Featured Box 2 Title','wp-musica'),
					"type" => "text"); 						
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 2 Image (leave empty if you don't need image.)",
					"desc" => "Upload an image for your featured box.",
					"id" => "box2_image",
					"std" =>  "/wp-content/uploads/2012/11/photodune-2461685-mask-xs.jpg",
					"type" => "upload");	

$of_options_musica_pmc[] = array( "name" => "Featured Box 2 Image link",
					"desc" => "Set the link to which the image points on click.",
					"id" => "box2_link",
					"std" => "http://premiumcoding.com",
					"type" => "text"); 							

$of_options_musica_pmc[] = array( "name" => "Featured Box 2 description",
					"desc" => "Set the description text for you featured box.",
					"id" => "box2_description",
					"std" => __('Featured Box 2 Description','wp-musica'),
					"type" => "textarea");
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 2 Background color",
					"desc" => "Set Background color.",
					"id" => "box2_color",
					"std" => "#ffffff",
					"type" => "color");							
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 3",
                    "type" => "innerheading");					

$of_options_musica_pmc[] = array( "name" => "Featured Box 3 Title",
					"desc" => "Title for the third featured box.",
					"id" => "box3_title",
					"std" => __('Featured Box 1 Title','wp-musica'),
					"type" => "text"); 	
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 3 Image (leave empty if you don't need image.)",
					"desc" => "Upload an image for your featured box.",
					"id" => "box3_image",
					"std" =>  "/wp-content/uploads/2012/11/photodune-2461685-mask-xs.jpg",
					"type" => "upload");
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 3 Image link",
					"desc" => "Set the link to which the image points on click.",
					"id" => "box3_link",
					"std" => "http://premiumcoding.com",
					"type" => "text"); 							
					
$of_options_musica_pmc[] = array( "name" => "Featured Box 3 description",
					"desc" => "Set the description text for you featured box.",
					"id" => "box3_description",
					"std" => __('Featured Box 3 Description','wp-musica'),
					"type" => "textarea");

$of_options_musica_pmc[] = array( "name" => "Featured Box 3 Background color",
					"desc" => "Set Background color.",
					"id" => "box3_color",
					"std" => "#ffffff",
					"type" => "color");						
...
$of_options_musica_pmc[] = array( "name" => "Our major brands images",
                    "type" => "innerheading");							


$of_options_musica_pmc[] = array( "name" => "Our major brands",
...
$of_options_musica_pmc[] = array( "name" => "Custom Logo",
					"desc" => "Upload a logo for your theme, or specify the image address of your online logo. (http://yoursite.com/logo.png)",
					"id" => "logo",
					"std" => "http://musica.premiumcoding.com/wp-content/uploads/2012/10/logo.png",
					"type" => "upload");
					
$of_options_musica_pmc[] = array( "name" => "Custom Favicon",
					"desc" => "Upload a 16px x 16px Png/Gif image that will represent your website's favicon.",
					"id" => "favicon",
					"std" => "http://curvey.premiumcoding.com/wp-content/uploads/2012/05/faviconLogo.png",
					"type" => "upload"); 					
							
 $of_options_musica_pmc[] = array( "name" => "Google Analytics",
                    "desc" => "Paste your Google analytics code here.",
                    "id" => "google_analytics",
                    "std" => "/",
                    "type" => "textarea");	   		                                               									
    
$of_options_musica_pmc[] = array( "name" => "Styling Options",
					"type" => "heading");

$of_options_musica_pmc[] = array( "name" =>  "Main Theme Color ",
					"desc" => "Set the main color for your theme.",
					"id" => "mainColor",
					"std" => "#EEC43D",
					"type" => "color");		
					
$of_options_musica_pmc[] = array( "name" =>  "Box Color ",
...
$of_options_musica_pmc[] = array( "name" =>  "Shadow Color ",
					"desc" => "Set the Shadow color for your fonts.",
					"id" => "ShadowColorFont",
					"std" => "#ffffff",
					"type" => "color");			

$of_options_musica_pmc[] = array( "name" => "Shadow opacity",
...
$of_options_musica_pmc[] = array( "name" => "Body background",
                    "type" => "innerheading");
					
$of_options_musica_pmc[] = array( "name" =>  "Body Background Color",
					"desc" => "Pick a background color for the theme.",
					"id" => "body_background_color",
					"std" => "#ffffff",
					"type" => "color");

$of_options_musica_pmc[] = array( "name" => "Enable Background Image",
					"desc" => "Displays an image not the color selected above",
					"id" => "background_image",
					"std" => 1,
					"type" => "checkbox");
					
$of_options_musica_pmc[] = array( "name" => "Background Pattern",
...
$of_options_musica_pmc[] = array( "name" => "Background Image Properties",
...
$of_options_musica_pmc[] = array( "name" => "Footer background ",
                    "type" => "innerheading");					
					
$of_options_musica_pmc[] = array( "name" => "Enable header and footer Background Pattern",
					"desc" => "Enable header and footer Background Image",
					"id" => "background_image_header",
					"std" => 1,
					"type" => "checkbox");
					
$of_options_musica_pmc[] = array( "name" =>  "Header and Footer Background Color",
					"desc" => "Header and Footer Background Color.",
					"id" => "header_background_color",
					"std" => "#F4F4F4",
					"type" => "color");
					
$of_options_musica_pmc[] = array( "name" => "Background header and footer Pattern",
...
$of_options_musica_pmc[] = array( "name" => "Background header and footer Image Properties",
					"desc" => "You can define additional shorthand properties for the background such as no-repeat here. This is for advanced CSS users only.",
					"id" => "header_bg_properties",
					"std" => "repeat 0 0",
					"type" => "text"); 		

$of_options_musica_pmc[] = array( "name" => "Custom Style",
                    "type" => "innerheading");				
...
$of_options_musica_pmc[] = array( "name" => "Slider options",
                    "type" => "heading");
					
$of_options_musica_pmc[] = array( "name" => "iosSlider",
                    "type" => "innerheading");					
...
$of_options_musica_pmc[] = array( "name" => "Full slider",
                    "type" => "innerheading");					
...
$of_options_musica_pmc[] = array( "name" => "Nivo slider",
                    "type" => "innerheading");					
...
$of_options_musica_pmc[] = array( "name" => "Main Settings",
                    "type" => "innerheading");	

$of_options_musica_pmc[] = array( "name" => "Background transparency of text holder",
					"desc" => "Set the background opacity / transparency of the text holder. (from 0 to 1)",
					"id" => "slider_opacity",
					"std" => "0.5",
					"type" => "text");						

$of_options_musica_pmc[] = array( "name" => "Transition time (for animation between images)",
					"desc" => "Set Transition time (for animation between images) - usually a value between 500ms and 1000ms.",
					"id" => "anispeed",
					"std" => "800",
					"type" => "text");

$of_options_musica_pmc[] = array( "name" => "Time of Appearance",
...
$of_options_musica_pmc[] = array( "name" => "Nivo Slider Options",
                    "type" => "innerheading");
													
					
$of_options_musica_pmc[] = array( "name" => "Slider text color and font size for Nivo slider",
					"desc" => "Font color and size for Content text",
					"id" => "slider_fontSize_colorNivo",
					"std" => array('size' => '24px','color' => '#ffffff'),
					"type" => "sizeColor");		
					
$of_options_musica_pmc[] = array( "name" => "Background color of text holder for Nivo slider",
					"desc" => "Set the Background color of text holder.",
					"id" => "slider_backColorNivo",
					"std" => "#1BAACC",
					"type" => "color");							

$of_options_musica_pmc[] = array( "name" => "Border color of text holder for Nivo slider",
					"desc" => "Set border color of text holder.",
					"id" => "slider_borderColorNivo",
					"std" => "#1BAACC",
					"type" => "color");		

$of_options_musica_pmc[] = array( "name" => "Slider Transition Effect ",
...
$of_options_musica_pmc[] = array( "name" => "Number of slices",
...
$of_options_musica_pmc[] = array( "name" => "Number of Boxes",
...
$of_options_musica_pmc[] = array( "name" => "Number of rows",
...
$of_options_musica_pmc[] = array( "name" => "Typography",
                    "type" => "heading");
					
$of_options_musica_pmc[] = array( "name" => "Body Typography Settings",
...
$of_options_musica_pmc[] = array( "name" => "Portfolio & Blog Options",
                    "type" => "heading");


					
$of_options_musica_pmc[] = array( "name" => "Number of items to be displayed per page",
...
$of_options_musica_pmc[] = array( "name" => "Blog",
                    "type" => "innerheading");		
					

$of_options_musica_pmc[] = array( "name" => "Number of items to be displayed on sorting blog per page",
...
$of_options_musica_pmc[] = array( "name" => "Social Options",
					"type" => "heading");  
					
$of_options_musica_pmc[] = array( "name" => "Social Icons",
...
$of_options_musica_pmc[] = array( "name" => "Contact Options",
					"type" => "heading");      
				
					
$of_options_musica_pmc[] = array( "name" => "Email address",
                    "desc" => "Set the email address to which the emails should be sent.",
                    "id" => "contactemail",
                    "std" => "info@yourmail.com",
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Error message",
                    "desc" => "Set the message that will appear in case of an error.",
                    "id" => "contacterror",
                    "std" => __('Error while sending mail.','wp-musica'),
                    "type" => "text");	 	

$of_options_musica_pmc[] = array( "name" => "Success message",
                    "desc" => "Set the message that will appear when email is sucesfully sent.",
                    "id" => "contactsuccess",
                    "std" => __('Success','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Error page",
					"type" => "heading");      

					
$of_options_musica_pmc[] = array( "name" => "404 Error page Title",
                    "desc" => "Set the title of the Error page (404 not found error).",
                    "id" => "errorpagetitle",
                    "std" => __('OOOPS! 404','wp-musica'),
                    "type" => "text");	
					
$of_options_musica_pmc[] = array( "name" => "404 Error page Sub Title",
...
$of_options_musica_pmc[] = array( "name" => "404 Error page Title Content Text",
                    "desc" => "Add a description for your 404 page.",
                    "id" => "errorpage",
                    "std" => __('Sorry, but the page you are looking for has not been found.<br/>Try checking the URL for errors, then hit refresh.</br>Or you can simply click the icon below and go home:)','wp-musica'),
                    "type" => "textarea");	   	
					
	
$of_options_musica_pmc[] = array( "name" => "Footer Options",
					"type" => "heading");      

$of_options_musica_pmc[] = array( "name" => "Show Social icon in footer",
					"desc" => "Check if you wish to show Social icon in footer",
					"id" => "showsocialfooter",
					"std" => 1,
					"type" => "checkbox");			
					
$of_options_musica_pmc[] = array( "name" => "Copyright info",
                    "desc" => "Add your Copyright or some other notice.",
                    "id" => "copyright",
                    "std" => __('&copy; 2011 All rights reserved. ','wp-musica'),
                    "type" => "textarea");	
...
$of_options_musica_pmc[] = array( "name" => "Translation",
					"type" => "heading");   	
									

					
							
$of_options_musica_pmc[] = array( "name" => "General Translaction",
                    "type" => "innerheading");								
					
$of_options_musica_pmc[] = array( "name" => "Menu",
                    "desc" => "Translation for menu text (responsive menu).",
                    "id" => "translation_menu",
                    "std" => __('Menu','wp-munmarket'),
                    "type" => "text");					
					
$of_options_musica_pmc[] = array( "name" => "Our latest posts",
                    "desc" => "Translation for Our latest posts text.",
                    "id" => "translation_post",
                    "std" =>  __('Our latest posts','wp-musica'),
                    "type" => "text");	
					
$of_options_musica_pmc[] = array( "name" => "Enter search",
                    "desc" => "Translation for enter search text in widget.",
                    "id" => "translation_enter_search",
                    "std" =>  __('Enter search...','wp-musica'),
                    "type" => "text");						
					
$of_options_musica_pmc[] = array( "name" => "Portfolio title on home page.",
                    "desc" => "Translation for portfolio title on home page.",
                    "id" => "translation_port",
                    "std" => __('Recent from Our portfolio','wp-musica'), 
                    "type" => "text");							
					
$of_options_musica_pmc[] = array( "name" => "Related post",
                    "desc" => "Translation for Related post text.",
                    "id" => "translation_relatedpost",
                    "std" => __('Related post','wp-musica'),
                    "type" => "text");						


$of_options_musica_pmc[] = array( "name" => "Home page Our major brands",
                    "desc" => "Translation for Home page Our major brands title.",
                    "id" => "translation_advertise_title",
                    "std" => __('Our major brands','wp-musica'),
                    "type" => "text");	
					
					

$of_options_musica_pmc[] = array( "name" => "Read more",
                    "desc" => "Translation for Read more.",
                    "id" => "translation_morelink",
                    "std" => __('Read more','wp-musica'),
                    "type" => "text");

$of_options_musica_pmc[] = array( "name" => "Portfolio Translaction",
                    "type" => "innerheading");
					

$of_options_musica_pmc[] = array( "name" => "Project Description",
					"desc" => "Set Project Description",
					"id" => "port_project_description",
					"std" => __('Project description:','wp-musica'),
					"type" => "text");		

$of_options_musica_pmc[] = array( "name" => "Project details",
					"desc" => "Set Project details",
					"id" => "port_project_details",
					"std" => __('Project details:','wp-musica'),
					"type" => "text");						
									
					
$of_options_musica_pmc[] = array( "name" => "Project URL",
					"desc" => "Set the Project URL Title",
					"id" => "port_project_url",
					"std" => __('Project URL:','wp-musica'),
					"type" => "text");			
					
$of_options_musica_pmc[] = array( "name" => "Project designer",
					"desc" => "Set the Project designer Title",
					"id" => "port_project_designer",
					"std" => __('Project designer:','wp-musica'),
					"type" => "text");	
					
$of_options_musica_pmc[] = array( "name" => "Project Date of completion",
					"desc" => "Set the Project Date of completion Title",
					"id" => "port_project_date",
					"std" => __('Date of completion:','wp-musica'),
					"type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Project Client",
					"desc" => "Set the Client Title",
					"id" => "port_project_client",
					"std" => __('Client:','wp-musica'),
					"type" => "text");		

$of_options_musica_pmc[] = array( "name" => "Share the project",
					"desc" => "Set the Share the project Title",
					"id" => "port_project_share",
					"std" => __('Share the <span>project</span>','wp-musica'),
					"type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Related project",
					"desc" => "Set the Related projject Title",
					"id" => "port_project_related",
					"std" => __('Related <span>project</span>','wp-musica'),
					"type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Show all",
                    "desc" => "Translation for Show all.",
                    "id" => "translation_all",
                    "std" => __('Show all:','wp-musica'),
                    "type" => "text");		
					
$of_options_musica_pmc[] = array( "name" => "Next project",
                    "desc" => "Translation for Next project.",
                    "id" => "translation_next_project",
                    "std" => __('Next project','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Previous project",
                    "desc" => "Translation for Previous project.",
                    "id" => "translation_previus_project",
                    "std" => __('Previous project','wp-musica'),
                    "type" => "text");							
									

$of_options_musica_pmc[] = array( "name" => "Blog translation",
                    "type" => "innerheading");

$of_options_musica_pmc[] = array( "name" => "Translation for text By",
                    "desc" => "Translation for text By.",
                    "id" => "translation_by",
                    "std" => __('By: ','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Translation for text Categories",
                    "desc" => "Translation for text Categories.",
                    "id" => "translation_categories",
                    "std" => __('Categories: ','wp-musica'),
                    "type" => "text");
					
$of_options_musica_pmc[] = array( "name" => "Translation for text Tags",
                    "desc" => "Translation for text Tags.",
                    "id" => "translation_tags",
                    "std" => __('Tags: ','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Share category post",
                    "desc" => "Translation for Share category post (+ icon ina category).",
                    "id" => "translation_share_category",
                    "std" => __('Share','wp-musica'),
                    "type" => "text");		

$of_options_musica_pmc[] = array( "name" => "Blog page title",
                    "desc" => "Translation for Blog page title.",
                    "id" => "translation_blog_page",
                    "std" => __('Welcome to <span>our blog</span>, we will keep you informed','wp-musica'),
                    "type" => "text");					

					

$of_options_musica_pmc[] = array( "name" => "Comment translation",
                    "type" => "innerheading");

$of_options_musica_pmc[] = array( "name" => "Leave a Reply text",
                    "desc" => "Translation for Leave a Reply title.",
                    "id" => "translation_comment_leave_replay",
                    "std" => __('Leave a Reply','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Leave a Reply to text",
                    "desc" => "Translation for Leave a Reply to title.",
                    "id" => "translation_comment_leave_replay_to",
                    "std" => __('Leave a Reply to','wp-musica'),
                    "type" => "text");		

$of_options_musica_pmc[] = array( "name" => "Cancle Replay text",
                    "desc" => "Translation for Cancle Replay title.",
                    "id" => "translation_comment_leave_replay_cancle",
                    "std" => __('Cancle Replay','wp-musica'),
                    "type" => "text");						

$of_options_musica_pmc[] = array( "name" => "Name text",
                    "desc" => "Translation for Name text.",
                    "id" => "translation_comment_name",
                    "std" => __('Name','wp-musica'),
                    "type" => "text");		

$of_options_musica_pmc[] = array( "name" => "Mail text",
                    "desc" => "Translation for Mail text.",
                    "id" => "translation_comment_mail",
                    "std" => __('Mail','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Website text",
                    "desc" => "Translation for Website text.",
                    "id" => "translation_comment_website",
                    "std" => __('Website','wp-musica'),
                    "type" => "text");							

$of_options_musica_pmc[] = array( "name" => "Required text",
                    "desc" => "Translation for required text.",
                    "id" => "translation_comment_required",
                    "std" => __('required','wp-musica'),
                    "type" => "text");							

$of_options_musica_pmc[] = array( "name" => "Comments are closed text",
                    "desc" => "Translation for Comments are closed text.",
                    "id" => "translation_comment_closed",
                    "std" => __('Comments are closed.','wp-musica'),
                    "type" => "text");		

$of_options_musica_pmc[] = array( "name" => "No Responses text",
                    "desc" => "Translation for No Responses text.",
                    "id" => "translation_comment_no_responce",
                    "std" => __('No Responses','wp-musica'),
                    "type" => "text");

$of_options_musica_pmc[] = array( "name" => "One Response text",
                    "desc" => "Translation One Response text.",
                    "id" => "translation_comment_one_comment",
                    "std" => __('One Response','wp-musica'),
                    "type" => "text");

$of_options_musica_pmc[] = array( "name" => "Responses text",
                    "desc" => "Translation for Responses text.",
                    "id" => "translation_comment_max_comment",
                    "std" => __('Responses','wp-musica'),
                    "type" => "text");					



$of_options_musica_pmc[] = array( "name" => "Contact translation",
                    "type" => "innerheading");	
...
$of_options_musica_pmc[] = array( "name" => "Email text",
                    "desc" => "Translation for Name text.",
                    "id" => "translation_contact_email",
                    "std" => __('Email','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Message text",
                    "desc" => "Translation for Message text.",
                    "id" => "translation_contact_message",
                    "std" => __('Message','wp-musica'),
                    "type" => "text");						

$of_options_musica_pmc[] = array( "name" => "Send text",
                    "desc" => "Translation for Send text.",
                    "id" => "translation_contact_send",
                    "std" => __('Send','wp-musica'),
                    "type" => "text");	

$of_options_musica_pmc[] = array( "name" => "Clear text",
                    "desc" => "Translation for Clear text.",
                    "id" => "translation_contact_clear",
                    "std" => __('Clear','wp-musica'),
                    "type" => "text");								
		
$of_options_musica_pmc[] = array( "name" => "Backup Options",
					"type" => "heading");

$of_options_musica_pmc[] = array( "name" => "Backup and Restore Options",
                    "id" => "of_backup",
                    "std" => "",
                    "type" => "backup",
...
$of_options_musica_pmc[] = array( "name" => "Transfer Theme Options Data",
                    "id" => "of_transfer",
